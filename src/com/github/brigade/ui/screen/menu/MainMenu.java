...
import com.github.brigade.ui.screen.component.ButtonActions;
...
public class MainMenu extends MenuScreen{
	...
	public MainMenu() {
		this(new Component[] { 
				new TexturedButton(Display.getWidth()/4,20,Display.getWidth()/2,Display.getHeight()/4,Textures.placeHolder1,ButtonActions.changeScreenToMainMenu),
				new TexturedButton(20,Display.getHeight()/4 + 25,width,height,new Texture[]{Textures.placeHolder1,Textures.placeHolder2},ButtonActions.changeScreeToGame),
				...
				new TexturedButton(20,Display.getHeight()/4 + 25 + 2 * height,width,height,new Texture[]{Textures.tempOptionsFirst,Textures.tempOptionsSecond},ButtonActions.changeScreenToOptionsMenu),
