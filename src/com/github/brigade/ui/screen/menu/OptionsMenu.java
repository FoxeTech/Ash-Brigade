...
public class OptionsMenu extends MenuScreen {
	...
	public static Component[] get() {
		...
		TexturedButton d = new TexturedButton(40,40,MainMenu.width,MainMenu.height,new Texture[]{Textures.placeHolder1,Textures.placeHolder2},ButtonActions.changeScreenToMainMenu);
